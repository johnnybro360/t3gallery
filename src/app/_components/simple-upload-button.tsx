...
function makeUploadToast(){
    return (
        toast(<div className="flex flex-row gap-2 text-white items-center">
            <LoadingSpinnerSVG /><span className="text-lg">Uploading...</span></div>, {
            duration: 100000,
            id: 'upload-begin'
        })
    )
...
// (window as any).makeToast = makeUploadToast;
